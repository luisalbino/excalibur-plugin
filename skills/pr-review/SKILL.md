...
índice + o badge que entregam a leitura priorizada** — não a ordem do array. Rode primeiro em
**dry-run** para conferir o payload, depois com `--post` para publicar (uma única review batchada):
```
